  ...
  return (
    <div className='w-full'>
        ...
        <Controller name={name || "content"} control={control} render={({field:{onChange}}) => (
            <Editor apiKey='isrpnl7htoqqka6z7itdig3aocf3y41a4g5vqf3cwws55snn' initialValue={defaultValue} init={{
                height: 500,
                menubar: false,
                ...
                content_style: 'body { font-family:Helvetica,Arial,sans-serif; font-size:14px }'}} onEditorChange={onChange}/>
        )}/>
    </div>
  )
}
